        ...
        <div className="w-full max-w-xl">
          ...
          <div className="grid grid-cols-1 gap-6 md:grid-cols-2">
            <div className="flex flex-col justify-center">
              ...
              <div className="mt-8 flex flex-wrap gap-3 bg-gray-300 rounded-md p-2 border-1 border-gray-50 font-mono">
            ...
            <div className="h-full w-full">
              <Card
                icon={libraries[0].img}
                title={libraries[0].title}
                description={libraries[0].desc}
                link="https://vitejs.dev"
                className="absolute rounded-lg border border-gray-100 bg-[#A692E1] p-4 h-60 w-60 ml-auto shadow-sm cursor-pointer"
              />
            </div>
          </div>
        </div>
